...
void platform_system_clock_pre_init() { SystemInit(); }
...
uint32_t hal_system_clock_get(void) { return HAL_RCC_GetSysClockFreq(); }
...
void hal_system_debug_flush(void) { /* Nothing to flush */ }
