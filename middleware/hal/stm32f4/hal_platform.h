/**
 * @file    hal_platform.h
 * @brief   STM32F4 platform-specific definitions (stub)
 * 
 * This file contains STM32F4-specific definitions for the HAL layer.
 ...
 * would require STM32F4 HAL library.
 */
...
/* Include HAL public types only if not already included */
#ifndef HAL_H
