...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "fallnet_stm32"
...
#define AI_NETWORK_IN_1_CHANNEL     (1200)
#define AI_NETWORK_IN_1_SIZE        (1200)
#define AI_NETWORK_IN_1_SIZE_BYTES  (4800)
